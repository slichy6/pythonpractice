    ...
    if ans.lower() == 'yes':
        ...
        while lvl1_choice not in lvl1_options:
            ...
            2. throw the box away''')
                                ...
                                if lvl4_choice == "1":
                                    print(f"you decided to keep looking, days later you still don't find it, YOU LOSE {name}!")
            ...
            your home, now you get to keep your beautiful house without the 
            spirits, CONGRATULATIONS {name} YOU WIN!''')    
...
#goodbye message if they enter no
        ...
        print(f"That's too bad, maybe next time {name}")
